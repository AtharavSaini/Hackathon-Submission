window.onload = () => {
  ...
  const summary =
    data.insights.summary || "Personal loan profile";
  ...
  if (!insightsData || insightsData.length === 0) {
    container.innerHTML = `
      <div class="insight-card info">
        ...
        <p class="impact">
          Your personal loan profile looks strong.
        </p>
        <p class="solution">
          Maintain timely EMIs and healthy credit utilization.
        </p>
      </div>
    `;
  } else {
  ...
  document.getElementById("exploreLoansBtn").onclick = () => {
    window.location.href = "result_personal.html";
  };
